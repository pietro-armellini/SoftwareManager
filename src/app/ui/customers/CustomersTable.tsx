...
import { Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, IconButton, Snackbar, SnackbarContent, Typography } from '@mui/material';
import { lightBlue, green, red } from '@mui/material/colors';
import { useRouter, useSearchParams } from 'next/navigation';
import CustomerEdit from './CustomerEdit';


//Component to view customers
export default function CustomersTable() {
  ...
  useEffect(() => {
    ...
    fetchData();
		//if param succ is true it means CustomerAdd component just pushed to the table after successfully adding a new entry
  ...
  const handleDeleteConfirmation = async () => {
    await fetch('/api/customers/removeCustomer', {
      method: 'POST',
      headers: {
    ...
    <Box>
      ...
      >
        <SnackbarContent
          ...
          message={`Customer "${deletedName}" deleted successfully`}
        />
      </Snackbar>
      ...
      <Dialog open={showConfirmationDialog} onClose={handleCloseConfirmationDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete the customer "{objectToDelete && objectToDelete.name}"?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
      ...
      <Dialog open={showEditDialog} onClose={closeEditDialog} PaperProps={{
        ...
        <DialogContent>
        <CustomerEdit elementToEdit={objectToEdit} handleCloseFromParentDialog={handleCloseEditDialogFromChild}/>     
        </DialogContent>
        <DialogActions>
